...
namespace Core.Utilities.Security.JWT
{
    ...
    {
        // IConfiguration Apı nin içersindeki appsettings okumamızı sağlar.
        public IConfiguration Configuration { get; }

        // appsettings de okuduğumuz değerleri TokenOptions nesnesine atıcaz
        private TokenOptions _tokenOptions;

        // AccessToken geçerlilik süresi
        ...
        {
            // JWT içinde kullanıcıya karşılık gelen bir çok şey var. Bunlar kullanıcıID, Email, Name, Rolller gibi
